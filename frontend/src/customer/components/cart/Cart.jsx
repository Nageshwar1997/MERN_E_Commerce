import React, { useEffect } from "react"; // { useEffect, useMemo }
          ...
          <div className="border p-4">
            ...
            <div className="space-y-3 font-semibold">
              ...
              <div className="flex justify-between pt-3">
                ...
                <span className="text-green-600">
                  {cart?.cart?.totalDiscountedPrice >= 499 ? "Free" : "+₹40.00"}
                </span>
              </div>
              <div className="w-full border-t flex justify-between items-center py-3 font-bold">
                <span>Total Amount</span>
                <span className="text-green-600">
                ₹{cart?.cart?.totalDiscountedPrice < 499
                    ? cart?.cart?.totalDiscountedPrice + 40
                    : cart?.cart?.totalDiscountedPrice}
                </span>
              </div>
              <Button
