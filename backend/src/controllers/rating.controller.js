...
const getProductAllRatingsController = async (req, res) => {
  try {
    const productId = req.params.id;

    const ratings = await getProductAllRatings(productId);
...
module.exports = { createRatingController, getProductAllRatingsController };
